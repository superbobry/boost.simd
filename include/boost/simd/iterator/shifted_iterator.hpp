...
//==============================================================================
#ifndef BOOST_SIMD_ITERATOR_SHIFTED_ITERATOR_HPP_INCLUDED
#define BOOST_SIMD_ITERATOR_SHIFTED_ITERATOR_HPP_INCLUDED

//#include <boost/simd/forward/shifted_iterator.hpp>
#include <boost/simd/pack.hpp>
#include <boost/simd/function/aligned_load.hpp>
//#include <boost/align/align_up.hpp>
#include <boost/simd/iterator/meta/region.hpp>
...
namespace boost { namespace simd
{
  template< typename Iterator
          , typename Region
          , std::size_t C = boost::simd::native_cardinal<typename std::iterator_traits<Iterator>::value_type>::value
          >
