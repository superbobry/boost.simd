...
//==============================================================================
#include <boost/simd/iterator/shifted_iterator.hpp>
...
STF_CASE_TPL("shifted_vector_iterator_scalar", STF_NUMERIC_TYPES )
{
